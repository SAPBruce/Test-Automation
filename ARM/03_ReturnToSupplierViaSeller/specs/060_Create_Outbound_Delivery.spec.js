...
describe("Create outbound delivery.", function () {
  ...
  it("step3:Clear planned creation date.", async function() {
  //----------------------- Block for sap.m.Input - Perform Set-Value -----------------------
  var ui5ControlProperties = {
  	"elementProperties":{"metadata":"sap.m.Input","mProperties":{"value":[{"path":"$smartEntityFilter>formattedText"}],"valueState":[{"path":"$smartEntityFilter>inputstate"}],"suggestionItems":[{"path":"operations"}]}},
  	"parentProperties":{"metadata":"sap.ui.layout.VerticalLayout","mProperties":{}},
  	"prevSiblingProperties":{"metadata":"sap.m.Label","mProperties":{"text":"Planned Creation Date"}},
  	"nextSiblingProperties":{},
  	"childProperties":{"metadata":"sap.ui.core.Icon","mProperties":{"src":"sap-icon://value-help"}}
  };
  var value = "";   //value to be entered by user
  await common.userInteraction.clearAndFill(ui5ControlProperties, value);
  });

  it("step4:Fill Document number.", async function() {
  ...
  it("step5:Click [Go] button to search.", async function() {
  ...
  it("step7:Click [Create Delivery] button.", async function() {
    //----------------------- Block for sap.m.Button - Perform Click -----------------------
    var ui5ControlProperties = {
    ...
    it("step8:Click [Display Log] button.", async function() {
    //----------------------- Block for sap.m.Button - Perform Click -----------------------
    var ui5ControlProperties = {
  ...
  it("step9:Get outbound delivery number.", async function() {
