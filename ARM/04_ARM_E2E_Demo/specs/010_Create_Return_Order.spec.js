...
describe("Create Return Order", function () {
  ...
  await ui5.common.locator.highlightElement(ui5ControlProperties,);
  await common.userInteraction.click(ui5ControlProperties);
  await browser.sleep(3000);
  });

  it("step3:setValue on sap.m.Input", async function() {
  //----------------------- Block for sap.m.Input - Perform Set-Value -----------------------
  var ui5ControlProperties = {
  	"elementProperties":{"metadata":"sap.m.Input","mProperties":{}},
  	"parentProperties":{"metadata":"sap.ui.layout.VerticalLayout","mProperties":{}},
  	"prevSiblingProperties":{"metadata":"sap.m.Label","mProperties":{"text":"Customer Reference"}},
  	"nextSiblingProperties":{},
  	"childProperties":{}
  };
  var value = "4455";   //value to be entered by user
...
//  await browser.sleep(5000);
  ...
  //----------------------- Block for sap.m.Button - Perform Click -----------------------
  var ui5ControlProperties = {
  	"elementProperties":{"metadata":"sap.m.Button","mProperties":{"text":[{"path":"@i18n>create"}],"bindingContextPath":"/C_ReturnsReferenceDocument('22543')"}},
  	"parentProperties":{"metadata":"sap.m.FlexItemData","mProperties":{"bindingContextPath":"/C_ReturnsReferenceDocument('22543')"}},
  	"prevSiblingProperties":{},
  	"nextSiblingProperties":{},
  	"childProperties":{}
  };
  ...
  it("Step 6: Click 'product defective'.", async function() {
    var elem = await non_ui5.common.locator.getElementByCss("[id*='__item32-cus.sd.customerreturns.manage.create.ext.fragments.CreateReturnPopup--CreateReturnDialog--ReturnReasonSelect-4");
    await non_ui5.common.locator.highlightElement(elem,1000);
    await non_ui5.common.userInteraction.click(elem);
  });
  it("step 7:Set value for return quantity.", async function() {
  //----------------------- Block for sap.m.Input - Perform Set-Value -----------------------
  var ui5ControlProperties = {
  ...
  it("step 8:Click create button on dialog page", async function() {
  //----------------------- Block for sap.m.Button - Perform Click -----------------------
  var ui5ControlProperties = {
  ...
  it("step9:Get return order number.", async function() {
