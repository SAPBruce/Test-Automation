...
describe("Perform Material Inspection.", function () {
  ...
  it("step 8: Fill follow up activity.", async function() {
  ...
  it("Step 9: Save and confirm.'", async function() {
  ...
  it("Step 10: Click 'exit'", async function() {
  ...
  it("Step 11: Logout", async function() {
    browser.ignoreSynchronization = true;
